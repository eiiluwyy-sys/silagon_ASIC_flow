...
proc apply_project_constraints {syn_dir clock_period_ps} {
...
set REPORT_DIR  ../syn/rpt/task3_${PERIOD_LABEL}
set OUT_DIR ../syn/db/task3_${PERIOD_LABEL}
set SOURCE_DIR ../rtl
set SYN_DIR ../syn
...
proc nth_pass {n} {
    ...
    global SOURCE_DIR SYN_DIR OUT_DIR TOP_NAME REPORT_DIR CLOCK_PERIOD_PS
    ...
    apply_project_constraints ${SYN_DIR} ${CLOCK_PERIOD_PS}
