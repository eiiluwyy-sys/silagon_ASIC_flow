...
if {[file exists "../syn/db/task2"]} {
    set SRC_DIR "../syn/db/task2"
} elseif {[file exists "../syn/db/task2_20ns"]} {
    set SRC_DIR "../syn/db/task2_20ns"
} elseif {[file exists "../syn/db/task2_10ns"]} {
    set SRC_DIR "../syn/db/task2_10ns"
} elseif {[file exists "../syn/db/task2_8ns"]} {
    set SRC_DIR "../syn/db/task2_8ns"
} elseif {[file exists "../syn/db/task2_6ns"]} {
    set SRC_DIR "../syn/db/task2_6ns"
} else {
    set SRC_DIR "../syn/db"
}
