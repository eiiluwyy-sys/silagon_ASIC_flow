...
# Reexam convention:
# Task 6 reads the canonical bottom-up handoff from syn/db/task3.
# Older directory names are kept only as fallbacks for historical compatibility.
if {[file exists "../syn/db/task3"]} {
    set SRC_DIR "../syn/db/task3"
} elseif {[file exists "../syn/db/task3_20ns"]} {
    set SRC_DIR "../syn/db/task3_20ns"
} elseif {[file exists "../syn/db/task3_10ns"]} {
    set SRC_DIR "../syn/db/task3_10ns"
} elseif {[file exists "../syn/db/flat_20ns"]} {
